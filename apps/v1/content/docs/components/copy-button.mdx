...
Toast will be loaded dynamically. If you don't want to have Toast, don't include `toastOptions` in props.
...
| <Code variant="prop">size?</Code> | <Code>enum</Code> <Info className="font-mono">"default" \| "sm" \| "lg" \| "icon" \| "icon-sm" \| "icon-lg"</Info> | <Code variant="variable">"default"</Code> |
