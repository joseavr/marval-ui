...
| `loading` <Info>The loading state of the button</Info> | `boolean` | `false` |
| `variant` <Info>The style for the button</Info> | `enum` <Info>"default" \| "destructive" \| "outline" \| "secondary" \| "ghost" \| "link" \| "brand-primary" \| "brand-secondary" \| "brand-tertiary" \| "brand-neutral-primary" \| "brand-neutral-secondary" \| "brand-neutral-tertiary" \| "brand-destructive-primary" \| "brand-destructive-secondary" \| "brand-destructive-tertiary"</Info>  | `"default"` | 
| `size` | `enum` <Info>"default" \| "sm" \| "lg" \| "icon"</Info> | `"default"` |
| `className` | `string` | - | 
