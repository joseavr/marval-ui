...
function ComponentPreviewDemo({
	...
	return (
		<div
			...
			data-align={align}
			className="flex h-fit max-h-fit min-h-[450px] w-full justify-center overflow-hidden overflow-x-auto p-10 data-[align=start]:items-start data-[align=end]:items-end data-[align=center]:items-center"
		>
			{children}
		</div>
	)
